...
export const Article: React.FC<ArticleProps> = ({ isWide }) => {
  return (
    <article className={styles.article}>
      ...
      {isWide ? (
        <div className={styles.fullBleed}>
          <img className={styles.image} src={plane} alt="Картинка самолёта" />
        </div>
      ) : (
      ...
      <Text dynamic size={18}>
        ...
        получился похожим на самого художника: такой же добродушный и с улыбкой до ушей.
      </Text>

      <Text dynamic size={18}>
        С мая 2017 года «Бомбардье» носит имя «Швейцарская Романдия» и
        регистрационный номер HB-JCA; совершает в среднем 4 коммерческих полёта в сутки.
        Его можно видеть в «Домодедово», а также в аэропортах Парижа, Валенсии,
        Кракова, Берлина, Вены, Загреба, на Майорке, Крите и Сицилии. Самолёт останется в той же ливрее, пока его не купит другая авиакомпания.
      </Text>
    </article>
  )
}
